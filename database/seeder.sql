...
INSERT INTO Item (name, description, image_url, category_id, user_id) VALUES
    ('iPhone 13 Pro', 'Latest iPhone model with advanced features', 'https://example.com/iphone13.jpg', 1, 1),
    ('Designer Handbag', 'Luxury handbag from a top designer brand', 'https://example.com/designer-handbag.jpg', 2, 2),
    ('Antique Oak Dining Table', 'Vintage dining table with intricate carvings', 'https://example.com/dining-table.jpg', 3, 3),
    ('The Great Gatsby', 'F. Scott Fitzgerald''s classic novel', 'https://example.com/great-gatsby.jpg', 4, 1),
    ('Mountain Bike', 'High-performance mountain bike for outdoor adventures', 'https://example.com/mountain-bike.jpg', 5, 2),
    ('Smart TV', 'Large-screen smart TV with 4K resolution', 'https://example.com/smart-tv.jpg', 1, 2),
    ('Leather Jacket', 'Stylish leather jacket for the fashion-savvy', 'https://example.com/leather-jacket.jpg', 2, 2),
    ('Vintage Record Player', 'Retro record player for vinyl enthusiasts', 'https://example.com/record-player.jpg', 3, 1);
