        ...
        <form method="post" action="create_auction_result.php">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <small id="selectHelp" class="form-text text-muted"><span class="text-danger">* Required.</span> Items
                already listed in other auctions are not available.</small>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <small id="endStartHelp" class="form-text text-muted"><span class="text-danger">* Required.</span> Day for
                the auction to begin.</small>
            </div>
          </div>
          <div class="form-group row">
