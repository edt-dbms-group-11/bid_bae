        ...
        <form method="post" action="create_item_result.php" enctype="multipart/form-data">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <small id="titleHelp" class="form-text text-muted"><span class="text-danger">* Required.</span> A short
                description of the item being registered, which will be displayed on the item page.</small>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <small id="detailsHelp" class="form-text text-muted">Full details of the item to help bidders understand
                the product.</small>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              <small id="image" class="form-text text-muted"><span class="text-danger">* Required.</span> View of the
                item.</small>
            </div>
          </div>
